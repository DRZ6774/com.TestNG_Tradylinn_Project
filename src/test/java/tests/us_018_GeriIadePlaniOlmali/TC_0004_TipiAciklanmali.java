...
public class TC_0004_TipiAciklanmali extends TestBaseReport {
    @Test
    public void testTC_0004()  {
        ...
        //10-Type degeri kontrol ediniz
        ReusableMethods.waitFor(10);
        String expectedType="Full Refund";
        String actualType=geriOdemePage.TypeDegeri.getText();
        Assert.assertEquals(expectedType,actualType);
        extentTest.info("Type degeri görüldü");
    }
}
