...
public class TC_0003_NeKadarUrunAlindigiBelliEdilmeli extends TestBaseReport {

    @Test
    public void testTC_0003() {
        ...
        //10-Amount degeri kontrol ediniz.
        ReusableMethods.waitFor(10);
        String expectedAmount="300.00₺";
        String actualAmount=geriOdemePage.AmountDegeri.getText();
        Assert.assertEquals(expectedAmount,actualAmount);
        extentTest.info("Amount degeri görüldü");
    }
}