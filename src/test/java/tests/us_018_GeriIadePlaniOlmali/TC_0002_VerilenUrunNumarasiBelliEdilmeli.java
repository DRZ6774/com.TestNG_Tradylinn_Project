...
public class TC_0002_VerilenUrunNumarasiBelliEdilmeli extends TestBaseReport {
    ...
    public void testTC_0002() {
        ...
        //10-OrderID degeri kontrol ediniz.
        ReusableMethods.waitFor(10);
        String expectedOrderID="#11381";
        String actualOrderID=geriOdemePage.OrderIDDegeri.getText();
        Assert.assertEquals(expectedOrderID,actualOrderID);
        extentTest.info("OrderID degeri görüldü");
    }
}
