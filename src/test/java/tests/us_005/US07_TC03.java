...
public class US07_TC03 extends TestBaseReport {
    UrunPage urunPage = new UrunPage();
    SoftAssert softAssert = new SoftAssert();
    Actions actions=new Actions(Driver.getDriver());

    @Test
    public void US07_TC03Testi() {
        extentTest=extentReports.createTest("US07_TC03","Product brands-NodeJS butonu secilebilmeli");
        ...
        //8-Product brands-NodeJS secin
        actions.sendKeys(Keys.PAGE_DOWN).sendKeys(Keys.PAGE_DOWN).perform();
        ReusableMethods.waitFor(2);
        urunPage.nodeJsButton.click();
        extentTest.info("Product brands-NodeJS butonuna tiklandi");

        //9-Product brands-NodeJS secilebilir oldugunu test edin
        softAssert.assertTrue(urunPage.nodeJsButton.isSelected());
        extentTest.info("Product brands-NodeJS  butonunun secilebilir oldugu test edildi");
        extentTest.pass("Product brands-NodeJS butonu secilebiliyor");
    }
}
