...
public class US06_TC05 extends TestBaseReport {
    UrunPage urunPage = new UrunPage();
    SoftAssert softAssert = new SoftAssert();
    Actions actions=new Actions(Driver.getDriver());
    JavascriptExecutor jse= (JavascriptExecutor) Driver.getDriver();
    @Test
    public void US06_TC05Testi() throws InterruptedException {
        extentTest=extentReports.createTest("US06_TC05","Categories-indirimli urunler butonu secilebilmeli");
        ...
        //7-Categories-indirimli urunler secin
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        Thread.sleep(2000);
        urunPage.indirimliUrunlerButton.click();
        extentTest.info("indirimli urunler butonuna tiklandi");

        //8-Categories-indirimli urunler secilebilir oldugunu test edin
        softAssert.assertTrue(urunPage.indirimliUrunlerButton.isSelected());
        extentTest.info("Categories-indirimli urunler butonunun secilebilir oldugu test edildi");
        extentTest.pass("Categories-indirimli urunler butonu secilebiliyor");
    }
}
