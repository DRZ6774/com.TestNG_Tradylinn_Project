...
public class US06_TC07 extends TestBaseReport {
    UrunPage urunPage = new UrunPage();
    SoftAssert softAssert = new SoftAssert();
    Actions actions=new Actions(Driver.getDriver());

    @Test
    public void US06_TC07Testi() throws InterruptedException {
        extentTest=extentReports.createTest("US06_TC07","Categories-Kozmetik & kisisel butonu secilebilmeli");
        ...
        //7-Categories-Kozmetik & kisisel secin
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        Thread.sleep(2000);
        urunPage.kozmetikKisiselButton.click();
        extentTest.info("Categories-Kozmetik & kisisel butonuna tiklandi");

        //8-Categories-Kozmetik & kisisel secilebilir oldugunu test edin
        softAssert.assertTrue(urunPage.kozmetikKisiselButton.isSelected());
        extentTest.info("Categories-Kozmetik & kisisel  butonunun secilebilir oldugu test edildi");
        extentTest.pass("Categories-Kozmetik & kisisel butonu secilebiliyor");
    }
}
